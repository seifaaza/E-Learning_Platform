    ...
    <Sheet open={isSheetOpen} onOpenChange={setSheetOpen}>
      <SheetTrigger asChild className="cursor-pointer">
        <Avatar className="relative after:absolute after:w-full after:h-full after:border-2 after:border-blue-400 after:rounded-full after:top-0 after:left-0">
          <AvatarFallback className="capitalize text-blue-600 pt-1">
            {username && username.slice(0, 2)}
          </AvatarFallback>
        </Avatar>
      </SheetTrigger>

      <SheetContent className="md:!max-w-xs bg-blue-700 !border-0 px-6 py-4 md:px-8 md:py-6 lg:px-10 lg:py-8 xl:px-12 flex flex-col justify-between">
        <section>
