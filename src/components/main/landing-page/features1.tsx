  ...
  return (
    <section className="bg-blue-600 isolate overflow-hidden">
      <article className="relative xl:container ">
        <Doodle2 className="top-10 left-32 w-24 " />
        <Doodle3 className="bottom-10 left-16 w-44 " />
        <Doodle4 className="bottom-1/2 left-1/2 w-60 " />
        <Doodle5 className="bottom-32 right-40 w-24 " />
        <Doodle8 className="bottom-1/3 left-[38%] w-32 " />
