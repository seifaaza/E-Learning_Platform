...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-blue-500 px-3 py-12 md:py-14 lg:py-16 relative isolate overflow-hidden">
      <Doodle16 className="rotate-90 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 sm:w-72 xl:w-80 !fill-blue-600/30" />
